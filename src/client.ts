...
import { LIST_PEN_ICONS, createSourceSelect, hostIcon } from "./source-select.js";
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var FeedbackIcon = hostIcon(primitives, LIST_PEN_ICONS);
    ...
    var useRepositoryUI = createRepositoryUI({ react: react, Modal: Modal, Input: primitives.Input, Button: primitives.Button, SourceSelect: SourceSelect, api: callApi, headers: MUTATION_HEADERS, translateError: translateError });
    var CSS = `
...
.dssm-table-head,.dssm-row{display:grid;grid-template-columns:minmax(180px,1fr) 120px 90px max-content;align-items:center;column-gap:12px;padding:0 13px}.dssm-table-head{min-height:32px;border-bottom:1px solid var(--dsw-alias-border-l1,#3a3a3a);color:var(--dsw-alias-label-tertiary,#a0a0a0);font-size:11px}.dssm-row{min-height:58px;border-bottom:1px solid var(--dsw-alias-border-l1,#3a3a3a)}.dssm-row:last-child{border-bottom:0}.dssm-main{min-width:0}.dssm-name{overflow-wrap:anywhere;font-size:13px;font-weight:570}.dssm-note{overflow-wrap:anywhere;margin-top:2px;color:var(--dsw-alias-label-secondary,#b9b9b9);font-size:11px;line-height:17px}.dssm-tags{display:flex;align-items:center;gap:5px;flex-wrap:wrap}.dssm-fallback-tag{display:inline-flex;align-items:center;border-radius:999px;padding:1px 8px;border:.5px solid var(--dsw-alias-border-l4,#666);color:var(--dsw-alias-label-tertiary,#a0a0a0);font-size:11px;line-height:17px;font-weight:500;white-space:nowrap}.dssm-fallback-switch{box-sizing:border-box;position:relative;flex:none;width:36px;height:20px;padding:2px;border:0;border-radius:10px;background:var(--dsw-alias-border-l3,#555);cursor:pointer}.dssm-fallback-switch[aria-checked=true]{background:var(--dsw-alias-state-success-primary,#3dbb7a)}.dssm-fallback-switch:disabled{cursor:default;opacity:.5}.dssm-fallback-switch:focus-visible{outline:2px solid var(--dsw-alias-state-success-primary,#3dbb7a);outline-offset:2px}.dssm-fallback-switch-thumb{display:block;width:16px;height:16px;border-radius:50%;background:var(--dsw-alias-label-primary-foreground,#fff);transition:transform 120ms ease}.dssm-fallback-switch[aria-checked=true] .dssm-fallback-switch-thumb{transform:translateX(16px)}.dssm-fallback-tabs{position:relative;display:grid;padding:4px;border-radius:12px;background:var(--dsw-alias-bg-module-platform,rgba(128,128,128,.12))}.dssm-fallback-tabs-indicator{position:absolute;top:4px;bottom:4px;left:4px;box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l3,#555);border-radius:8px;background:var(--dsw-alias-bg-layer-3,#353638);transition:transform 180ms ease;pointer-events:none}.dssm-fallback-tab{position:relative;display:inline-flex;align-items:center;justify-content:center;gap:6px;height:34px;padding:0 12px;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#b9b9b9);font:inherit;font-size:14px;line-height:20px;cursor:pointer}.dssm-fallback-tab[aria-selected=true]{color:var(--dsw-alias-label-primary,#eee);font-weight:600}.dssm-fallback-tab:focus-visible{outline:none;text-decoration:underline;text-underline-offset:4px}@media(prefers-reduced-motion:reduce){.dssm-fallback-tabs-indicator,.dssm-fallback-tab,.dssm-fallback-switch-thumb{transition:none}}.dssm-enabled{color:var(--dsw-alias-state-success-primary,#51b976);font-size:12px;white-space:nowrap}.dssm-disabled{color:var(--dsw-alias-state-warn-primary,#d49245);font-size:12px;white-space:nowrap}.dssm-shadowed{color:var(--dsw-alias-label-tertiary,#a0a0a0);font-size:12px;white-space:nowrap}.dssm-row-actions{display:flex;align-items:center;justify-content:flex-end;gap:7px}
.dssm-switch{position:relative;width:34px;height:20px;flex:none;padding:0;border:0;border-radius:999px;background:var(--dsw-alias-border-l3,#555555);cursor:pointer}.dssm-switch:after{position:absolute;top:3px;left:3px;width:14px;height:14px;border-radius:50%;background:var(--dsw-alias-label-primary-foreground,var(--dsw-alias-bg-layer-1,#202020));content:"";transition:transform 160ms ease}.dssm-switch-on{background:var(--dsw-alias-state-success-primary,#3dbb7a)}.dssm-switch-on:after{transform:translateX(14px)}.dssm-switch:disabled{opacity:.45;cursor:default}.dssm-trash-count{padding:2px 7px;border-radius:99px;background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,.12));color:var(--dsw-alias-label-secondary,#b9b9b9);font-size:11px}.dssm-empty{padding:25px 14px;color:var(--dsw-alias-label-tertiary,#a0a0a0);font-size:12px;text-align:center}.dssm-feedback{padding:9px 11px;border:1px solid var(--dsw-alias-border-l2,#494949);border-radius:8px;color:var(--dsw-alias-label-secondary,#b9b9b9);font-size:12px}.dssm-warning{border-color:var(--dsw-alias-state-warn-primary,#d49245);color:var(--dsw-alias-state-warn-primary,#d49245)}.dssm-error{border-color:var(--dsw-alias-state-error-primary,#ef7272);color:var(--dsw-alias-state-error-primary,#ef7272)}
...
@container(max-width:780px){.dssm-source-path{display:none}.dssm-table-head{display:none}}@media(max-width:760px){.dssm-summary{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:720px){.dssm-title-row{flex-wrap:wrap}}@container(max-width:520px){.dssm-tabs{gap:16px}.dssm-trash-item{flex-wrap:wrap}.dssm-trash-main{flex-basis:100%}.dssm-head{flex-direction:column}.dssm-actions{width:100%;margin-left:0}.dssm-actions button{flex:1}.dssm-filters{flex-direction:column}.dssm-source-filter{width:100%}.dssm-summary{grid-template-columns:1fr}}
/* 与归档页统一控件外观；保留官方输入和菜单的交互行为。 */
.dssm-section .dssm-input,.dssm-host-modal .dssm-input{height:34px;padding:0 10px;border:1px solid var(--dsw-alias-border-l2,#494949);border-radius:8px;background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-bg-layer-2,#353638))}
.dssm-section .dssm-input:focus-within,.dssm-host-modal .dssm-input:focus-within{border-color:var(--dsw-alias-label-tertiary,#a0a0a0)}.dssm-host-modal-body{display:flex;flex-direction:column;gap:16px;min-width:0;max-height:min(640px,70vh);overflow:auto}
...
`;
    ...
    function nextScopeTab(current: string, key: string) {
    ...
    function handleModalEscape(event: React.KeyboardEvent, onClose: () => void) { if (event.key !== "Escape") return false; event.preventDefault(); event.stopPropagation(); if (event.nativeEvent && typeof event.nativeEvent.stopImmediatePropagation === "function") event.nativeEvent.stopImmediatePropagation(); onClose(); return true; }

    function Switch(props: {on: boolean; label: string; disabled?: boolean; onClick: () => void}) {
      if (typeof primitives.Switch === "function") return h(primitives.Switch, { checked: props.on, label: props.label, disabled: props.disabled, className: "dssm-switch-on", onChange: function () { props.onClick(); } });
      return h("button", { type: "button", className: "dssm-fallback-switch", role: "switch", "aria-checked": props.on, "aria-label": props.label, disabled: props.disabled, onClick: props.onClick }, h("span", { className: "dssm-fallback-switch-thumb" }));
    }
    function hostTag(label: React.ReactNode) {
      if (typeof primitives.Tag === "function") return h(primitives.Tag, { tone: "outline" }, label);
      return h("span", { className: "dssm-fallback-tag" }, label);
    }
    function FallbackTabs(props: {label: string; value: string; onChange: (value: string) => void; items: {value: string; id: string; panelId: string; label: React.ReactNode}[]}) {
      var count = props.items.length;
      var selected = Math.max(0, props.items.findIndex(function (item) { return item.value === props.value; }));
      function move(index: number, key: string) {
        ...
        else if (key === "ArrowRight" || key === "ArrowDown") next = (index + 1) % count;
        else return;
        var item = props.items[next];
        if (!item) return;
        props.onChange(item.value);
        var tab = document.getElementById(item.id);
        if (tab instanceof HTMLElement) tab.focus();
      }
      return h("div", { className: "dssm-fallback-tabs", role: "tablist", "aria-label": props.label }, h("span", { className: "dssm-fallback-tabs-indicator", "aria-hidden": true, style: { width: "calc((100% - 8px) / " + count + ")", transform: "translateX(" + (selected * 100) + "%)" } }), props.items.map(function (item, index) {
        return h("button", { key: item.value, id: item.id, type: "button", role: "tab", "aria-selected": props.value === item.value, "aria-controls": item.panelId, tabIndex: props.value === item.value ? 0 : -1, className: "dssm-fallback-tab", onClick: function () { props.onChange(item.value); }, onKeyDown: function (event: React.KeyboardEvent<HTMLButtonElement>) { if (!["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Home", "End"].includes(event.key)) return; event.preventDefault(); move(index, event.key); } }, item.label);
      }));
    }
    function hostButton(label: React.ReactNode, onClick: () => void, kind: "primary" | "outline" | "quiet" | "danger" = "primary", disabled?: boolean) { return h(primitives.Button, { variant: kind === "quiet" ? "ghost" : kind === "primary" ? "primary" : "outline", size: "sm", className: kind === "danger" ? "dssm-btn-danger" : undefined, disabled: disabled, onClick: onClick }, label); }
    ...
    function Modal(props: ModalProps) {
      ...
      react.useLayoutEffect(function () {
        ...
        var dialog = document.querySelector(".dssm-host-modal");
        recoverModalFocus(dialog instanceof HTMLElement ? dialog : null, document.activeElement, document.body);
      });
      react.useEffect(function () {
        if (typeof document === "undefined") return;
        var dialog = document.querySelector(".dssm-host-modal");
        var focusable = dialog instanceof HTMLElement ? modalFocusable(dialog) : [];
      ...
      return h(primitives.Modal, { open: true, title: props.title, closeLabel: props.closeLabel, onClose: props.onClose, className: "dssm-host-modal" + (props.wide ? " dssm-host-modal-wide" : "") + (props.className ? " " + props.className : "") }, h("div", { className: "dssm-host-modal-body" }, props.children));
    }
    ...
    function SkillManagerView(props: ViewProps) {
      ...
      function renderSkill(root: RootView, skill: SkillView) {
        ...
        return h("div", { key: root.key + ":" + skill.name, className: "dssm-row" },
          h("div", { className: "dssm-name" }, skill.declaredName || skill.name),
          h("div", { className: "dssm-row-state" }, h("span", { className: "dssm-status " + cls, title: statusTitle }, t(key)), root.toggleable !== false ? h(Switch, { on: enabled, disabled: busy || root.enabled === false || skill.loadable === false, label: t("skill.toggle") + " " + skill.name, onClick: function () { post(enabled ? "/disable" : "/enable", { root: root.key, name: skill.name }); } }) : null),
          h("div", { className: "dssm-row-meta" }, h("div", { className: "dssm-row-source" }, skill.installSource ? h("a", { href: "https://github.com/" + skill.installSource.owner + "/" + skill.installSource.name, target: "_blank", rel: "noreferrer", title: t("repo.source") }, skill.installSource.owner + "/" + skill.installSource.name) : t("repo.local"), !root.mutable ? hostTag(t("status.readonly")) : null), renderFallback(skill)),
          h("div", { className: "dssm-row-actions" }, hostButton(t("btn.detail"), function () { openDetail(root, skill); }, "quiet"), actions.length ? h(SourceSelect, { action: true, label: t("btn.more"), disabled: busy, options: actions, onChange: function (action) {
      ...
      function renderRoot(root: RootView) {
        ...
        return h("section", { key: root.key, className: "dssm-source" },
          h("div", { className: "dssm-source-head" },
            h("button", { type: "button", className: "dssm-source-head-main", "aria-expanded": open, "aria-controls": panelId, onClick: function () { setExpanded(function (previous) { return Object.assign({}, previous, { [expansionKey]: !open }); }); } },
            ...
            canToggleSource(root) ? h("span", { className: "dssm-source-actions" }, h(Switch, { on: root.enabled, disabled: busy, label: t("source.toggle") + " " + displayName, onClick: function () { post(root.enabled ? "/source-disable" : "/source-enable", { root: root.key }); } })) : null),
          h("div", { id: panelId, className: "dssm-source-body", hidden: !open }, open ? filtered.length ? h(react.Fragment, null,

            filtered.map(function (row) { return renderSkill(root, row.skill); })) : h("div", { className: "dssm-empty" }, t("empty.source")) : null));
      }
      function renderList() {
      ...
      var HostTabs = typeof primitives.SegmentedTabs === "function" ? primitives.SegmentedTabs : FallbackTabs;
      var tabs = h(HostTabs as typeof primitives.SegmentedTabs, { key: "tabs", className: "dssm-scope-tabs", label: t("scope.label"), value: scope, onChange: setScope, items: tabItems as [{ value: string; label: React.ReactNode; id: string; panelId: string }, ...{ value: string; label: React.ReactNode; id: string; panelId: string }[]] });
      var skillControls = [ h("div", { key: "summary", className: "dssm-summary" }, [["total", "summary.total"], ["enabled", "summary.enabled"], ["disabled", "summary.disabled"], ["invalid", "summary.invalid"]].map(function (item) { return h("div", { key: item[1], className: "dssm-stat" }, h("strong", null, summary[item[0]]), t(countKey(item[1], summary[item[0]]), { count: summary[item[0]] }).replace(String(summary[item[0]]), "")); })), h("div", { key: "filters", className: "dssm-filters" }, h(primitives.Input, { className: "dssm-input dssm-search", value: query, "aria-label": t("search"), placeholder: t("search.placeholder"), onChange: function (e) { setQuery(e.target.value); } }), h("div", { className: "dssm-source-filter" }, h(SourceSelect, { value: activeSource, label: t("filter.source"), options: options, onChange: setSource })), h("div", { className: "dssm-status-filter" }, h(SourceSelect, { value: filters.status, label: t("filter.status"), options: [{ value: "", label: t("filter.statusAll") }].concat(["enabled", "disabled", "shadowed", "invalid"].map(function (value) { return { value: value, label: t("status." + value) }; })), onChange: function (value) { updateFilter("status", value); } })))];
      var content: React.ReactNode[] = ([h("style", { key: "css" }, CSS), h("div", { key: "head", className: "dssm-head" }, h("div", { className: "dssm-title-block" }, h("div", { className: "dssm-title-row" }, h("h2", { className: "dssm-title" }, t("title")), h("div", { className: "dssm-feedback-links" }, h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager", target: "_blank", rel: "noreferrer", "aria-label": t("link.project") }, h(GithubMark16, null), t("link.project")), h("a", { className: "dssm-feedback-link", href: "https://github.com/MichengAI/dsh-skills-manager/issues", target: "_blank", rel: "noreferrer", "aria-label": t("link.feedback") }, h(FeedbackIcon, null), t("link.feedback")))), h("p", { className: "dssm-desc" }, t("desc")))), tabs, scope === "repositories" ? repositoryUI.actions : h("div", { key: "actions", className: "dssm-actions" }, hostButton(t("btn.refresh"), function () { refresh(false); }, "outline", busy || snapshot.loading), scope !== "trash" ? hostButton(t("btn.create"), openCreate, "primary", busy || !createRoot) : null, scope !== "trash" ? hostButton(t("import.global"), function () { setResult(null); setUpload(null); setModal("import"); }, "outline") : null)] as React.ReactNode[]).concat(scope === "trash" || scope === "repositories" ? [] : skillControls, [result && modal !== "import" ? h("div", { key: "result", className: "dssm-feedback" + (result.warning ? " dssm-warning" : result.ok ? "" : " dssm-error") }, result.text) : null], (data.warnings || []).map(function (warning, index) { return h("div", { key: "warning-" + index, className: "dssm-feedback dssm-warning", role: "alert" }, translateError(t, warning)); }), [snapshot.error ? h("div", { key: "error", className: "dssm-feedback dssm-error" }, snapshot.error) : null, snapshot.loading && !snapshot.data ? h("div", { key: "loading", className: "dssm-empty" }, t("loading")) : scope === "repositories" ? repositoryUI.content : scope === "trash" ? renderTrash() : renderList()]);

      if (modal === "create") content.push(h(Modal, { key: "create", title: t("create.title"), closeLabel: t("btn.close"), onClose: function () { setModal(null); } }, h("div", { className: "dssm-form" }, h("label", { className: "dssm-field" }, h("span", { className: "dssm-label" }, t("create.target")), h("div", { className: "dssm-detail-path" }, t("create.globalTarget"), createRoot && createRoot.path ? " · " + createRoot.path : "")), [["name", "create.name", "create.name.placeholder"], ["description", "create.description", "create.description.placeholder"]].map(function (field) { return h("label", { key: field[0], className: "dssm-field" }, h("span", { className: "dssm-label" }, t(field[1])), h(primitives.Input, { className: "dssm-input", value: form[field[0]], placeholder: t(field[2]), onChange: function (e) { updateForm(field[0], e.target.value); } })); }), h("label", { className: "dssm-field" }, h("span", { className: "dssm-label" }, t("create.body")), h("textarea", { className: "dssm-control", value: form.body, placeholder: t("create.body.placeholder"), onChange: function (e: React.ChangeEvent<HTMLTextAreaElement>) { updateForm("body", e.target.value); } })), h("p", { className: "dssm-help" }, t("create.chat.note"))), h("div", { className: "dssm-modal-actions" }, hostButton(t("btn.cancel"), function () { setModal(null); }, "outline"), hostButton(t("btn.create.now"), submitCreate, "primary", busy || !form.name.trim() || !form.description.trim() || !form.body.trim()))));
