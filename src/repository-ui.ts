...
export const repositoryLocales = {
  zh: {
    ...
    "repo.hint": "从公开 GitHub 或 Bitbucket 仓库发现技能，按需安装到全局 DSH。", "repo.footer": "刷新会检查仓库与技能更新，不会自动替换本地文件。历史备份不会自动清理，占用空间会随更新增加。",
  ...
  en: {
    ...
    "repo.hint": "Discover skills in public GitHub or Bitbucket repositories and install them to global DSH.", "repo.footer": "Refresh checks repositories and skill updates without replacing local files. Historical backups are not cleaned automatically and use additional disk space.",
