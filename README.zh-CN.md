...
本文对应 **1.1.1**。完整变更见[更新日志](CHANGELOG.zh-CN.md)与[最新发行说明](https://github.com/Jasun0925/dsh-skills-manager/releases/latest)。
...
- `1.1.1` 已验证兼容 DeepSeek Harness `0.1.0-rc.8`、`0.1.1-rc.2`、`0.1.2-rc.1`、`0.1.5-rc.1`、`0.1.5-rc.2`、`0.1.6-alpha.1`、`0.1.6-alpha.2`、`0.1.7-alpha.1`。
