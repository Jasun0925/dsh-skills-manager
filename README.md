...
This README describes **1.1.2**. See the [changelog](CHANGELOG.md) and [release notes](https://github.com/Jasun0925/dsh-skills-manager/releases/latest).
...
- Plugin `1.1.2` is tested with DeepSeek Harness `0.1.0-rc.8`, `0.1.1-rc.2`, `0.1.2-rc.1`, `0.1.5-rc.1`, `0.1.5-rc.2`, `0.1.6-alpha.1`, `0.1.6-alpha.2`, `0.1.7-alpha.1`.
